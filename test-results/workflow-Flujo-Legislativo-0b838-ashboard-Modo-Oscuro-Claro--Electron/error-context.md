...
- Name: workflow.spec.js >> Flujo Legislativo y UX Transversal >> Configuración Inicial y Dashboard (Modo Oscuro/Claro)
- Location: test\e2e\workflow.spec.js:21:3
...
Call log:
  ...
  - waiting for locator('header span')
