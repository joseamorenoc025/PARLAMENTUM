...
- Name: workflow.spec.js >> Flujo Legislativo y UX Transversal >> Integridad Visual y Logout
- Location: test\e2e\workflow.spec.js:92:3
...
Call log:
  - waiting for locator('nav button:has-text("Dashboard")')
