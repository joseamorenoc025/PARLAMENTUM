...
const OnboardingWizard = ({ darkMode, onComplete, addToast }) => {
  ...
  const validateStep = () => {
    const newErrors = {};
    if (step === 2) {
      if (formData.password.length < 12) newErrors.password = 'Mínimo 12 caracteres';
          ...
          <div className="space-y-6 animate-in fade-in slide-in-from-bottom-4 duration-500">
            ...
            <div className="flex flex-col gap-3">
              <button 
                ...
                className="w-full py-4 bg-indigo-600 hover:bg-indigo-700 text-white rounded-2xl font-black flex items-center justify-center gap-2 transition-colors shadow-xl shadow-indigo-500/20"
              >
                Comenzar configuración <ChevronRight className="w-5 h-5" />
              </button>
              <button 
                onClick={() => setStep(5)}
                className={`w-full py-3 rounded-xl font-bold text-sm transition-colors flex items-center justify-center gap-2 ${darkMode ? 'text-gray-500 hover:text-gray-300' : 'text-gray-400 hover:text-gray-600'}`}
              >
              ...
              <div className="grid grid-cols-2 gap-4">
                <div>
                  ...
                  <input 
                    ...
                    className={`w-full p-3.5 rounded-2xl border outline-none focus:ring-2 focus:ring-indigo-500 transition-colors ${darkMode ? 'bg-gray-800 border-gray-700' : 'bg-gray-50 border-gray-200'}`}
                  />
          ...
          <div className="space-y-6 animate-in fade-in slide-in-from-right-4 duration-300">
            ...
            <div className="space-y-4">
              ...
              <div className="pt-4">
                ...
                <div className={`w-full p-8 border-2 border-dashed rounded-2xl flex flex-col items-center justify-center transition-colors ${darkMode ? 'border-gray-800 bg-gray-800/20' : 'border-gray-200 bg-gray-50'}`}>
                  {formData.logoBuffer ? (
                    ...
                    <>
                      ...
                      <button 
                        ...
                        className="mt-4 px-4 py-2 bg-indigo-500/10 text-indigo-500 rounded-lg text-xs font-bold hover:bg-indigo-500/20 transition-colors"
                      >
                        Seleccionar archivo
                      </button>
                    </>
      ...
      case 4:
            ...
            <div className="space-y-6 animate-in fade-in slide-in-from-right-4 duration-300 py-4">
              ...
              <div className="flex gap-4 pt-8">
                ...
                <button 
                  ...
                  className={`flex-1 py-4 rounded-2xl font-black uppercase tracking-widest text-xs shadow-lg flex items-center justify-center transition-colors ${
        ...
        return (
          <div className="space-y-6 animate-in zoom-in duration-500 text-center py-4">
            ...
            <div className={`p-6 rounded-2xl border-2 border-dashed text-left ${darkMode ? 'bg-gray-900 border-indigo-500/30' : 'bg-indigo-50 border-indigo-200'}`}>
              ...
              <div className="flex flex-col gap-3 mb-6">
                <label className={`flex items-center p-3 rounded-xl cursor-pointer border-2 transition-colors ${saveOption === 'A' ? 'border-indigo-500 bg-indigo-500/5' : (darkMode ? 'border-gray-800' : 'border-gray-200')}`}>
                ...
                <label className={`flex items-center p-3 rounded-xl cursor-pointer border-2 transition-colors ${saveOption === 'B' ? 'border-indigo-500 bg-indigo-500/5' : (darkMode ? 'border-gray-800' : 'border-gray-200')}`}>
                ...
                <label className={`flex items-center p-3 rounded-xl cursor-pointer border-2 transition-colors ${saveOption === 'C' ? 'border-indigo-500 bg-indigo-500/5' : (darkMode ? 'border-gray-800' : 'border-gray-200')}`}>
              ...
              {saveOption === 'A' && (
                <div className="animate-in fade-in slide-in-from-bottom-2 duration-300">
                  ...
                  <button onClick={handleCopyCode} className="w-full py-4 bg-indigo-600 hover:bg-indigo-700 text-white rounded-xl font-black uppercase tracking-widest text-xs flex items-center justify-center gap-2 transition-colors shadow-lg shadow-indigo-500/20">
            ...
            <button 
              ...
              className="w-full py-5 bg-indigo-600 hover:bg-indigo-700 text-white rounded-2xl font-black shadow-xl shadow-indigo-500/20 transition-colors uppercase tracking-widest mt-4"
            >
  ...
  return (
    <div className="fixed inset-0 z-[60] flex items-center justify-center p-4 bg-black/60 backdrop-blur-md overflow-y-auto">
      <div className={`w-full max-w-2xl rounded-2xl border shadow-2xl p-8 md:p-12 ${darkMode ? 'bg-gray-950 border-gray-800 text-white' : 'bg-white border-gray-100'}`}>
        {step < 4 && (
