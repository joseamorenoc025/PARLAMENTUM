      ...
      <div className={`max-w-3xl mx-auto p-10 rounded-[2.5rem] border shadow-2xl ${darkMode ? 'bg-gray-900 border-gray-800 text-white' : 'bg-white border-gray-100'}`}>
        ...
        <div className="space-y-8">
          ...
          <div className="flex gap-4 pt-4">
            ...
            <button onClick={handleSave} className="flex-1 py-5 bg-indigo-600 hover:bg-indigo-700 text-white rounded-2xl font-black transition-all shadow-2xl shadow-indigo-500/30 uppercase tracking-[0.2em] text-xs">
